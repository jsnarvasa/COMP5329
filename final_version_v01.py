...
Original file is located at
    https://colab.research.google.com/drive/12RoYMmozwHoNSLfafzSknZKLWo-Pq6nI
"""
...
class MLP:
    def __init__(self, layers=4, activation = [None, 'relu', 'relu','relu'], weight_decay = 1):
    ...
    def fit(self, X, y, learning_rate = 0.1, epochs = 100, SGD_optim = None, batch_size = 1):
        ...
        for k in range(epochs):
            ...
            for batch_idx in range(num_batches):
                ...
                '''
                # check metrics
                test_predict = nn.predict(test_df.X)
                train_predict = nn.predict(train_df.X)
            ...
            print(f'Epoch {k} has been trained with loss {str(to_return[-1:])}')
...
print("Time taken to build model:", t1 - t0)
